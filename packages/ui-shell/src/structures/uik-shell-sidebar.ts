    ...
    return html`
      ...
      >
        <div part="header" style=${styleMap(headerStyles)}>
          <div
            part="header-content"
            style=${styleMap({ minWidth: "var(--uik-space-0)" })}
          >
            ${this.heading
              ? html`<div part="heading" style=${styleMap(headingStyles)}>
                  ${this.heading}
                </div>`
              : nothing}
            ${this.subtitle
              ? html`<div part="subtitle" style=${styleMap(subtitleStyles)}>
                  ${this.subtitle}
                </div>`
              : nothing}
          </div>
