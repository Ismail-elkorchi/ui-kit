...
export const styles = css`
  ...
  .panel-start {
    flex: 0 0 var(--uik-resizable-panels-start-size, var(--uik-component-resizable-panels-panel-start-size));
    min-width: var(--uik-resizable-panels-min-start, var(--uik-component-resizable-panels-panel-min-size));
  }

  .panel-end {
    flex: 1 1 auto;
    min-width: var(--uik-resizable-panels-min-end, var(--uik-component-resizable-panels-panel-min-size));
  }
  ...
  :host([orientation='vertical']) .panel-start {
    min-height: var(--uik-resizable-panels-min-start, var(--uik-component-resizable-panels-panel-min-size));
  }

  :host([orientation='vertical']) .panel-end {
    min-height: var(--uik-resizable-panels-min-end, var(--uik-component-resizable-panels-panel-min-size));
  }
  ...
  .handle:hover .handle-grip {
    background-color: oklch(var(--uik-component-resizable-panels-handle-hover-bg));
  }

  .handle:active .handle-grip,
  .base.dragging .handle-grip {
    background-color: oklch(var(--uik-component-resizable-panels-handle-active-bg));
  }
