...
const readTabIndex = (element: TabIndexLike) =>
  typeof element.tabIndexValue === "number"
    ? element.tabIndexValue
    : element.tabIndex;

export const expectRovingTabIndex = (
  elements: TabIndexLike[],
  activeIndex: number,
) => {
...
export const getShadowActiveElement = (root: ShadowRoot | null) =>
