...
describe("uik control primitives", () => {
  ...
  it("associates checkbox slots with aria and required validity", async () => {
    ...
    checkbox.innerHTML =
      '<span slot="label">Terms</span><span slot="hint">Helpful</span>';
    checkbox.shadowRoot
    ...
    checkbox.innerHTML =
      '<span slot="label">Terms</span><span slot="error">Required</span>';
    checkbox.shadowRoot
      ?.querySelector<HTMLSlotElement>('slot[name="label"]')
      ?.dispatchEvent(new Event("slotchange"));
    checkbox.shadowRoot
  ...
  it("initializes select defaults and responds to options slot changes", async () => {
    ...
    const optionsSlot =
      dynamic.shadowRoot?.querySelector<HTMLSlotElement>("slot[data-options]");
  ...
  it("applies select aria attributes and required validity", async () => {
    ...
    select.shadowRoot
      ...
      ?.dispatchEvent(new Event("slotchange"));
    select.shadowRoot
      ?.querySelector<HTMLSlotElement>("slot[data-options]")
      ?.dispatchEvent(new Event("slotchange"));
    await select.updateComplete;
