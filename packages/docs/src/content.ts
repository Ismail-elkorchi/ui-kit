...
export const shellDocs: ComponentDoc[] = [
  ...
  {
    id: 'shell-file-tree',
    name: '<uik-shell-file-tree>',
    summary: 'Tree view style list with selection and open state.',
    attributes: ['items (array)', 'selectedPaths (string[])', 'openPaths (string[])'],
    slots: ['None.'],
    parts: ['tree', 'row', 'toggle', 'checkbox', 'label', 'children'],
    events: ['file-tree-select', 'file-tree-open', 'file-tree-toggle'],
    a11y: ['Uses buttons and checkboxes; open/close is keyboard accessible.'],
    cssVars: [
      '--uik-component-shell-file-tree-row-*',
      '--uik-component-shell-file-tree-indent',
      '--uik-component-shell-file-tree-text-*',
      '--uik-component-shell-file-tree-toggle-fg',
    ],
  },
  {
    id: 'shell-router',
