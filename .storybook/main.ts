...
const config = {
  ...
  viteFinal: async baseConfig => {
    ...
    const dedupe = new Set([...(resolve.dedupe ?? []), 'lit', 'lit-html', 'lit-element', '@lit/reactive-element']);
    ...
    const alias = [
      ...
      {find: /^lit-element\//, replacement: `${getPackageRoot('lit-element')}/`},
      {find: /^@lit\/reactive-element$/, replacement: getEntryPath('@lit/reactive-element')},
      {find: /^@lit\/reactive-element\//, replacement: `${getPackageRoot('@lit/reactive-element')}/`},
    ];
